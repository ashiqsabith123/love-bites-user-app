                ...
                return Row(
                  ...
                  children: [
                    SelectImage(
                      ...
                      statusWidget: image1,
                      onPressed: () {
                        context.read<PhotoUploadBloc>().add(SelectPhoto(id: 1));
                      },
                    ),
                    SelectImage(
                      screenSize: screenSize,
                      statusWidget: image2,
                      onPressed: () {
                        context.read<PhotoUploadBloc>().add(SelectPhoto(id: 2));
                      },
                    )
                  ],
                );
                ...
                return Row(
                  ...
                  children: [
                    SelectImage(
                      ...
                      statusWidget: image3,
                      onPressed: () {
                        context.read<PhotoUploadBloc>().add(SelectPhoto(id: 3));
                      },
                    ),
                    SelectImage(
                      screenSize: screenSize,
                      statusWidget: image4,
                      onPressed: () {
                        context.read<PhotoUploadBloc>().add(SelectPhoto(id: 4));
                      },
                    )
                  ],
                );
